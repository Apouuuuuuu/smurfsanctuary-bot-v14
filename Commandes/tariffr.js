...
module.exports = {
    ...
    async run(bot, message, args) {
        ...
        .addFields(
            ...
            { name: '<:diamondlol:1092429533598195742> Compte diamant', value: '45€'},  
            ...
            { name: '<:valoplatinum3:1092386589004537946> Compte platine', value: '20€'},  
            { name: '<:valodiamond3:1092386593882525796> Compte diamant', value: '47€'},  
            { name: '<:valoascendant3:1092386586047557662> Compte ascendant', value: '65€'},
            { name: '<:europe:1095974176717803601>**__Régions disponnibles__**', value: 'BR LAS LAN TR RU OCE NA EUNE EUW'},  
            { name: '<:shoppingcart:1092385345078820924> **__Acheter__**', value: '<#1091261839674986506>'},  
        )
