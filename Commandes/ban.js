...
module.exports = {
    ...
    async run(bot, message, args) {
        ...
        try {
            ...
            if(message.user.id === user.id) return message.reply("Ne te bannis pas toi même !")
            if((await message.guild.fetchOwner()).id === user.id) return message.reply("Ne bannis pas le propriétaire du serveur !")
